    ...
    return (
        <div className='col-12 p-0 ' >
            ...
            <div class="blog-card">
                <div class="meta">
                    <div class="photo"
                        style={{ backgroundImage: 'url(https://storage.googleapis.com/chydlx/codepen/blog-cards/image-1.jpg)' }}></div>
                    <ul class="details">
                        <li class="author">
                            <img src={authorIcon} class='icon-details' alt="" />
                            <a href="#">La laborantine</a></li>
                        <li class="date">
        ...
        praesentium, quam nobis! Neque ad aliquam facilis numquam. Veritatis, sit.</p>
                    <p class="read-more">
                        <a href="#">Read More
                        <img src={arrowIcon} class='arrow' alt="" /></a>
