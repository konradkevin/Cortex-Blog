...
import InstagramFeed from "../component_sub/InstagramFeed";
            ...
            <article className='aside-card shadow pb-2'>
                ...
                <div className='img-aside'>
                    ...
                    <div>
                        <p>
                            Hi all!
                            To celebrate the 10th article of the blog La laborantine which arrives next week we are organizing a contest to win a goodie for the logo of the blog.
                            You have until the end of next week to participate! For that leave a comment at the bottom of an article of your choice on the blog!  Thereafter, a draw among the names of the participants will be organized.
                            At your comments!
                        </p>
                    </div>
                </div>
