  ...
  return (
    <div className='lang-fixed'>
      <OverlayTrigger
        ...
        <div className='lang-picker lang-fr' onClick={() => {
          setLanguage('fr')
        }}><img src={path_logo_fr} alt='logo fr'/></div>
      </OverlayTrigger>

      <OverlayTrigger
        placement={'right'}
        overlay={<Tooltip>English</Tooltip>}>
        <div className='lang-picker lang-en' onClick={() => {
          setLanguage('en')
        }}><img src={path_logo_en} alt='logo en'/></div>
      </OverlayTrigger>

      <OverlayTrigger
        placement={'right'}
        overlay={<Tooltip>Español</Tooltip>}>
        <div className='lang-picker lang-es' onClick={() => {
          setLanguage('es')
        }}><img src={path_logo_es} alt='logo es'/></div>
      </OverlayTrigger>
    </div>
  );
}
